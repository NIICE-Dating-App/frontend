...
export default function PetsEdit() {
  ...
  const loadCurrentData = async () => {
    try {
      ...
      const tempKey = `temp_pets_${user.id}`;
      ...
      if (lifestyleData?.pets) {
        setSelected(lifestyleData.pets);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    if (!selected) {
      Alert.alert("Missing Info", "Please select your pet preference.");
      return;
    }
          ...
          >
            ...
            <View style={styles.infoNote}>
              ...
              <Text style={styles.infoNoteText}>
                Let others know about your pets or pet preferences.
              </Text>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
