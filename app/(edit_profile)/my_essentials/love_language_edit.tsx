...
export default function LoveLanguageEdit() {
  ...
  const loadCurrentData = async () => {
    try {
      ...
      const tempKey = `temp_love_language_${user.id}`;
      ...
      if (lifestyleData?.love_language) {
        setSelected(lifestyleData.love_language);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    if (!selected) {
      Alert.alert("Missing Info", "Please select your love language.");
      return;
    }
          ...
          >
            ...
            <View style={styles.infoNote}>
              ...
              <Text style={styles.infoNoteText}>
                Share how you prefer to receive love and affection.
              </Text>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
