...
export default function ZodiacSignEdit() {
  ...
  const loadCurrentData = async () => {
    try {
      ...
      const tempKey = `temp_zodiac_${user.id}`;
      ...
      if (lifestyleData?.zodiac) {
        setSelected(lifestyleData.zodiac);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    if (!selected) {
      Alert.alert("Missing Info", "Please select your zodiac sign.");
      return;
    }
          ...
          >
            ...
            <View style={styles.infoNote}>
              ...
              <Text style={styles.infoNoteText}>
                Share your zodiac sign with others.
              </Text>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
