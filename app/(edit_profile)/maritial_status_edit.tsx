// frontend/app/(edit_profile)/marital_status_edit.tsx
...
// Marital status options matching marital_status_enum
const MARITAL_STATUS_OPTIONS = [
  { value: "single", label: "Single", emoji: "💫" },
  { value: "in_relationship", label: "In a relationship", emoji: "💑" },
...
export default function MaritalStatusEdit() {
  ...
  const loadCurrentData = async () => {
    try {
      ...
      const tempKey = `temp_marital_status_${user.id}`;
      ...
      setSelected(profileData?.marital_status || null);
    } catch (error) {
        ...
        >
          ...
          >
            <View pointerEvents="none">
              <Text style={styles.pageTitle}>What's your status?</Text>
            ...
            <View style={styles.infoNote} pointerEvents="none">
              ...
              <Text style={styles.infoNoteText}>
                This helps others understand what kind of connections you might be looking for.
              </Text>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
