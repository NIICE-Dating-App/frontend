...
const ENUM_MAP: Record<string, string> = {
  "A long term relationship": "long_term_relationship",
  "A life partner": "life_partner",
...
export default function HopeToFindSignup() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // optional: update onboarding step in profiles
      await supabase
        .from("profiles")
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          It’s your dating journey, choose 1 or 2 options that feels right for you.
        </Text>
        ...
        <Text style={styles.note}>
          This information is going to be shown on your profile.
        </Text>
      </ScrollView>
