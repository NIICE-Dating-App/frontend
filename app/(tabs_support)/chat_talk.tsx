        ...
        if (status === "SUBSCRIBED") {
          ...
          if (!pollingInterval) {
            pollingInterval = setInterval(() => {
              loadMessages(matchInfo.conversationId, currentUserId);
            }, 3000); // Poll every 3 seconds
          }
        }
      });

    // Start polling initially as a safety net, will be cleared if realtime connects
    pollingInterval = setInterval(() => {
      if (!isRealtimeConnected) {
        loadMessages(matchInfo.conversationId, currentUserId);
      }
    }, 5000); // Poll every 5 seconds if realtime isn't connected
